    ...
    <div class="top-menu">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                ...
                <div class="hide-md small-right-menu">
                <ul>
                <li class="nav-item">
                ...
                <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="images/user.png" class=" tooltip-icon fa-2x" data-toggle="tooltip" data-placement="bottom" title="قائمة الرسائل"></i> <i class="fas fa-angle-down"></i>
                            </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto align-items-center show-md">
                        <li class="nav-item">
                            <a class="nav-link search-icon" href="#">
                                <i class="fas fa-search tooltip-icon" data-toggle="tooltip" data-placement="bottom" data-original-title="بحث"></i></a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="images/user.png" class="tooltip-icon" data-toggle="tooltip" data-placement="bottom" title="قائمة الرسائل"><i class="fas fa-angle-down"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="#"><i class="fas fa-desktop"></i> لوحة التحكم</a>
                                <a class="dropdown-item" href="#"><i class="fas fa-cog"></i> اعدادات الحساب</a>
