            ...
            <div class="service-container">
                <div class="tabs-head">
                    <ul>
                        <li class="active"><a href="#">
                            <span class="hide-xs">وصف  الخدمة</span>
                            <span class="show-xs">الوصف</span> 
                        </a></li>
                        <li><a href="#add-to-service">
                            <span class="hide-xs">إضافات للخدمة</span>
                            <span class="show-xs">الاضافات</span>
                        </a></li>
                        <li><a href="#service-reviw">
                            <span class="hide-xs">تقييم الخدمة</span>
                            <span class="show-xs">التقييم</span>
                        </a></li>
                        <li><a href="#suggest-serv">خدمات مقترحة
                ...
                <div class="box-content">
                    ...
                    <div class="row">
                                ...
                                <div class="serv-content">
                                    <form>
                                        ...
                                        <div class="row pt-5 align-items-center">
                                            ...
                                            <div class="col-md-4  col-6 text-left text-md-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-12 pr-md-0">
